...
class Graph(Scene):
    ...
    #Lines in graph
        ...
        line_AB = DashedLine(point_A + UP * 2, point_B + DOWN * 5, dash_length=0.15, color="#739b99", stroke_width=3)
        line_C = DashedLine(point_C + UP * 4.3, point_C + DOWN * 1.8, dash_length=0.15, color="#739b99", stroke_width=3)
