...
class Graph(Scene):
    ...
    # Dotted line and label
        ...
        line_13 = DashedLine(node_1, node_3.get_top(), dash_length=0.15, color= "#24867e", stroke_width=3).shift(LEFT * 0.15)

        line_label = Tex("Incomplete", color = text_black, stroke_color = "#24867e" , 
