...
class Graph(Scene):
    ...
    # Lines in Sub-graph
        line_0k = DashedLine(point_0k + UP * 0.6, point_0k, dash_length=0.15, color="#739b99", stroke_width=3)
        ...
        line_sub1 = DashedLine(point_sub1, point_sub1 + RIGHT * 3, dash_length=0.15, color="#739b99", stroke_width=3)
        line_sub2 = DashedLine(point_sub2, point_sub2 + RIGHT * 3, dash_length=0.15, color="#739b99", stroke_width=3)
